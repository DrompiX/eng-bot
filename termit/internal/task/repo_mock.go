...
// Source: gitlab.ozon.dev/DrompiX/homework-2/termit/internal/task (interfaces: Repository)
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *task) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetById(arg0 context.Context, arg1 TaskID) (task, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 *task) error {
	m.ctrl.T.Helper()
